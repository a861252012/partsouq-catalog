...
本文彙整專案的操作與契約細節：後台功能、車輛與零件 mapping 語意、
本機啟動、migration 升級流程、統一排程入口與 MySQL 端到端測試。
...
目前契約與收攤狀態見 [progress-log-2026-09-03.md](progress-log-2026-09-03.md)；
bounded 時期契約見 [progress-log-2026-08-30.md](progress-log-2026-08-30.md)；
歷史測試紀錄見 [verification-2026-08-15.md](verification-2026-08-15.md)。
