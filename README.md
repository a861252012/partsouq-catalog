...
這個專案在 2026-09-03 收攤。最終成果：Lexus、Nissan、Toyota 三個品牌的
零件目錄約 388.9 萬筆，資料庫與程式都保留在原地，可供查詢與研究。

停止的過程記錄在
[docs/progress-log-2026-09-03.md](docs/progress-log-2026-09-03.md)。
簡言之：full crawl 逐品牌補齊的過程碰上站方行為連番更動（首頁品牌清單
浮動、locate 入口被 301 正規化、證據約束跟著調整），VIN 補爬又被
reCAPTCHA 擋死。每一項都修得起，但站方行為不受本專案控制，繼續投入
的效益不划算，決定停損。
